package com.example.asus.jingdong.ui.OrderList.adapter;
...
public class OrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        orderViewHolder.order_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("取消订单".equals(orderViewHolder.order_button.getText().toString())) {
                    //弹出对话框，提示用户是否删除
                    dialog = new AlertDialog.Builder(context)
                            ...
                            .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    //调用修改订单状态接口
                                   ordersPresenter.updateOrder(uid, "2", dataBean.getOrderid() + "", token);
                                }
                            }).show();
                }
    ...
    public void refresh(List<GetOrdersBean.DataBean> data) {
        if (list != null) {
            list.clear();
        }
        list.addAll(data);
    ...
    public void loadMore(List<GetOrdersBean.DataBean> data) {
        if (list != null) {
            list.addAll(data);
            notifyDataSetChanged();
        }
